...
export default function WsComponent() {
    ...
    function sendMessage(e) {
        ...
        if (ws.current && input.trim() !== "") {//check if ws is connected and if user types some msg
            const msg = {
            ...
            <div className="bg-surface rounded-lg shadow-xl overflow-hidden flex flex-col w-[900px] h-[600px] border border-surface-muted">
                ...
                <div className="bg-surface p-4 text-text-primary flex justify-between items-center border-b border-surface-muted z-10">
                    <div>
                        ...
                        <p className="text-text-muted">Logged in as: {randomUsername}</p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-surface">
                    ...
                    {messages.map((msg, index) => {
                        const isMe = msg.username === randomUsername;
                        return (
                            <div 
                                key={index} 
